...
7.  If you are going back and retroactively renaming files and uploading them to s3, be sure to make a note that you did so for each deployment on the [master spreadsheet for tracking game camera deployments](https://docs.google.com/spreadsheets/d/1BOhUKaEgA_SBqcY5-1pQn0K4DWbebujMcA5R0G-3m6k/edit?gid=0#gid=0) (privacy protected - link may not work).
