...
The general workflow we have developed for processing and logging image data from game cameras is depicted in @fig-1.

![General workflow for processing and logging game camera images](images/north-country-wild-camera-workflow.png){#fig-1 fig-alt="Image processing workflow" fig-align="center"}
...
Within each year's subdirectory, we include two subdirectories. One is called "Raw" and the other is called "Processed" (@fig-2).
