...
df <- read_csv(here("data/script-names.csv")) #read in table of script names
...
- Information on how to check which deployments have been uploaded to s3 is covered in @sec-Chapter5.
...
- Further information on how to use this script will be covered in @sec-Chapter6.
