...
df <- read_csv(here("data/upload_and_process_subcommands.csv")) #read in table of subcommands
...
: Arguments required by completely_process_images_from_sd_card subcommand
